...
${OBJECTDIR}/Arrival.o: Arrival.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arrival.o Arrival.cpp
...
${OBJECTDIR}/Depart.o: Depart.cpp
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Depart.o Depart.cpp
...
${TESTDIR}/tests/AeroportTesteur.o: tests/AeroportTesteur.cpp 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/AeroportTesteur.o tests/AeroportTesteur.cpp


${TESTDIR}/tests/ArriveeTesteur.o: tests/ArriveeTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/ArriveeTesteur.o tests/ArriveeTesteur.cpp


${TESTDIR}/tests/DepartTesteur.o: tests/DepartTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/DepartTesteur.o tests/DepartTesteur.cpp


${TESTDIR}/tests/VolTesteur.o: tests/VolTesteur.cpp 
	${MKDIR} -p ${TESTDIR}/tests
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I. -MMD -MP -MF "$@.d" -o ${TESTDIR}/tests/VolTesteur.o tests/VolTesteur.cpp
...
${OBJECTDIR}/Airport_nomain.o: ${OBJECTDIR}/Airport.o Airport.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Airport_nomain.o Airport.cpp;\
	else  \
...
${OBJECTDIR}/Arrival_nomain.o: ${OBJECTDIR}/Arrival.o Arrival.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Arrival_nomain.o Arrival.cpp;\
	else  \
...
${OBJECTDIR}/Depart_nomain.o: ${OBJECTDIR}/Depart.o Depart.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Depart_nomain.o Depart.cpp;\
	else  \
...
${OBJECTDIR}/Flight_nomain.o: ${OBJECTDIR}/Flight.o Flight.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Flight_nomain.o Flight.cpp;\
	else  \
